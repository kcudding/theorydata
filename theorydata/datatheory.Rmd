...
Before zebra mussel invasion / after 
Statndard idea: there was a regime shift vs there wsan;t


## Wait... is that actually what a mechanistic model predicts?
-asymptotitic vs transient dynamics predicted by models
...
there was a regime shift vs there was slow change (i.e. the system does not have bistable dynamics)


- alternative explanations:
  1. there was a regime shift to a 2nd stable state cause by the distrubance of the zebra mussel invaions
  2. there was a long transient following the erosian of the the stability of the eutrophic state beacuase of a lingering ghost attractor
  3. also...there was slow change (i.e. the system does not have bistable dynamics)
...
## Probably a long transient, probably not zebra mussesl



## Alternate explanations for the same observation WITH THE SAME MODEL

-the system DOES have bistable dyanmics but either
1. the parameter values are in a regime such that there is no sudden change
2. there parameter values DO allow sudden change, but there is a long tranisent before that change
